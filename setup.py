...
setup(
    name=NAME,
    version="0.11.1",  # this will be bumped automatically by bump2version
    ...
    extras_require={
        ...
        "test": [
            ...
            "flake8==5.0.2",  # ensure consistency with pre-commit
            "black==22.6.0",  # pin black version because it is not compatible with a pip range (because of non semver version number)
