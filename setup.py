...
setup(
    name=NAME,
    version="0.7.1",  # this will be bumped automatically by bump2version
    ...
    extras_require={
        ...
        "tests": [
            ...
            "black==21.4b2",  # pin black version because it is not compatible with a pip range (because of non semver version number)
