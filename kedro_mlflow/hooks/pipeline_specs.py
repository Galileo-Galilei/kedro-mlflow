...
class MlflowPipelineHook:
    ...
    def before_pipeline_run(
        ...
        mlflow.set_tag("kedro_command", _generate_kedro_command(tags=run_params["tags"], 
...
def _format_conda_env(conda_env: Union[str, Path, Dict[str, Any]] = None) -> Dict[str, Any]:
