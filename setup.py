...
setup(
    name=NAME,
    version="0.7.6",  # this will be bumped automatically by bump2version
    ...
    extras_require={
        ...
        "test": [
            ...
            "black==21.12b0",  # pin black version because it is not compatible with a pip range (because of non semver version number)
